...
public class CameraPreview extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public CameraPreview(Context context, digitalcard.digitalcard.Scan.CameraWrapper cameraWrapper, Camera.PreviewCallback previewCallback) {
        super(context);
        init(cameraWrapper, previewCallback);
    }

    public CameraPreview(Context context, AttributeSet attrs, digitalcard.digitalcard.Scan.CameraWrapper cameraWrapper, Camera.PreviewCallback previewCallback) {
        super(context, attrs);
        init(cameraWrapper, previewCallback);
    }

    public void init(digitalcard.digitalcard.Scan.CameraWrapper cameraWrapper, Camera.PreviewCallback previewCallback) {
    ...
    public void setCamera(digitalcard.digitalcard.Scan.CameraWrapper cameraWrapper, Camera.PreviewCallback previewCallback) {
    ...
    private Camera.Size getOptimalPreviewSize() {
        ...
        int w = getWidth();
        int h = getHeight();
        if (digitalcard.digitalcard.Scan.DisplayUtils.getScreenOrientation(getContext()) == Configuration.ORIENTATION_PORTRAIT) {
            int portraitWidth = h;
            h = w;
            w = portraitWidth;
        }
