...
public abstract class BarcodeScannerView extends FrameLayout implements Camera.PreviewCallback  {
    private digitalcard.digitalcard.Scan.CameraWrapper mCameraWrapper;
    private digitalcard.digitalcard.Scan.CameraPreview mPreview;
    private digitalcard.digitalcard.Scan.IViewFinder mViewFinderView;
    private Rect mFramingRectInPreview;
    private digitalcard.digitalcard.Scan.CameraHandlerThread mCameraHandlerThread;
    ...
    public final void setupLayout(digitalcard.digitalcard.Scan.CameraWrapper cameraWrapper) {
        removeAllViews();

        mPreview = new digitalcard.digitalcard.Scan.CameraPreview(getContext(), cameraWrapper, this);
     ...
     */
    protected digitalcard.digitalcard.Scan.IViewFinder createViewFinderView(Context context) {
        return new digitalcard.digitalcard.Scan.ViewFinderView(context);
    }

    public void startCamera(int cameraId) {
        if(mCameraHandlerThread == null) {
            mCameraHandlerThread = new digitalcard.digitalcard.Scan.CameraHandlerThread(this);
        }
        mCameraHandlerThread.startCamera(cameraId);
    }

    public void setupCameraPreview(digitalcard.digitalcard.Scan.CameraWrapper cameraWrapper) {
    ...
    public void startCamera() {
        startCamera(digitalcard.digitalcard.Scan.CameraUtils.getDefaultCameraId());
    }
    ...
    public void setFlash(boolean flag) {
        mFlashState = flag;
        if(mCameraWrapper != null && digitalcard.digitalcard.Scan.CameraUtils.isFlashSupported(mCameraWrapper.mCamera)) {
