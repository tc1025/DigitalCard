...
public class ViewFinderView extends View implements IViewFinder {
    ...
    protected int mFramingRound = 25;
    ...
    private void init() {
        ...
        DashPathEffect dashPathEffect = new DashPathEffect(
                new float[]{10.0f, 10.0f}, //interval
                0);       //phase
...
//        canvas.drawLine(framingRect.right + 1, framingRect.bottom + 1, framingRect.right + 1 - mBorderLineLength, framingRect.bottom + 1, mBorderPaint);
        ...
        canvas.drawRoundRect(new RectF(framingRect),mFramingRound,mFramingRound,mBorderPaint);
    }
    ...
    public void drawLaser(Canvas canvas) {
        ...
        canvas.drawRect(framingRect.left - 30, middle - 1, framingRect.right + 30, middle + 2, mLaserPaint);
    ...
    public synchronized void updateFramingRect() {
        ...
        int topOffset = ((viewResolution.y - height) / 2) - 100;
        mFramingRect = new Rect(leftOffset - 30, topOffset, leftOffset + width + 30, topOffset + height);
    }
}
