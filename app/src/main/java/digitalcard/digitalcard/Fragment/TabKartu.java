...
public class TabKartu extends Fragment {
    ...
    private class ListCardAdapter extends RecyclerView.Adapter<ListCardAdapter.MyViewHolder>{
        ...
        class MyViewHolder extends RecyclerView.ViewHolder {
            TextView cardName, cardMerchant;
            ImageView cardIcon;
            LinearLayout card;
            ...
            MyViewHolder(View view) {
                ...
                cardMerchant = view.findViewById(R.id.merchant_name);
            }
        }
        ...
        public void onBindViewHolder(MyViewHolder holder, final int position) {
            ...
            if (data.cardIcon == null) {
                holder.cardMerchant.setText(data.cardCategory);
                holder.cardMerchant.setVisibility(View.VISIBLE);
